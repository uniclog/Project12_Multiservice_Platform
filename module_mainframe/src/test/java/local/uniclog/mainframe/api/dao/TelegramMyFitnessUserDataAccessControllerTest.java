...
/**
 * Unit tests for TelegramMyFitnessUserDataAccessController
 */
@WebMvcTest(controllers = TelegramMyFitnessUserDataAccessController.class)
class TelegramMyFitnessUserDataAccessControllerTest {

    private static final String api = "/api/TelegramMyFitnessUserDataAccessController";
