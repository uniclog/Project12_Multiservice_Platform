...
@Slf4j
@Lazy
@Component(value = "ts3sMessageGoTo")
public class VlcGoToStation extends TeamspeakMessageAbstract {
    ...
    /**
     * Goto new station and get station title
     *
    ...
    public String messageType() {
        return MessageType.GOTO.getTextValue();
    }
}