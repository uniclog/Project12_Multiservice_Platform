...
/**
 * Unit tests for TelegramUnicBotCoreUserDataAccessController
 */
@WebMvcTest(controllers = TelegramUnicBotCoreUserDataAccessController.class)
class TelegramUnicBotCoreUserDataAccessControllerTest {

    private static final String api = "/api/TelegramUnicBotCoreUserDataAccessController";
